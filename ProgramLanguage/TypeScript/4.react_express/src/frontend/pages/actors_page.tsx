...
export class ActorPage extends React.Component {
  ...
  public render() {
    const error =
      this.actorStore.loadStatus === "error"
        ? new Error("Actors could not be loaded!")
        : null;
    const actors =
      this.actorStore.loadStatus === "pending" ? null : this.actorStore.actors;
    return (
      <Container>
        <Row>
          <Column
        ...
        <Modal
          ...
          error={
            this.actorStore.saveStatus === "error"
        ...
        >
          <form>
            <TextField
              id="actor_title"
              value={
                this.actorStore.editorValue
                  ? this.actorStore.editorValue.name
                  : ""
              }
              title="Name"
              placeholder="Name"
            ...
            <TextField
              ...
              value={
                this.actorStore.editorValue
                  ? this.actorStore.editorValue.yearBorn
                  : 2018
              }
              title="Year of Birth"
        ...
        <Modal
          ...
          error={
            this.actorStore.deleteStatus === "error"
              ? new Error("Something went wrong")
              : undefined
          }
        >
